'''
FEEDBACK
1. Your use of package/library goes against the rules of the task
2. check line 42
3. check the feedback repo for the implementation done by others
'''
...
class CheckObstruction:
    ...
    def checkObstruction(self):
        ...
        """
        return ActualTime().calActualTime()  > self.expectedTime() + 60:
